      ...
      body: SafeArea(
        ...
        child: Column(
          children: [
            ...
            Padding(
              padding: const EdgeInsets.all(17),
              child: cont2("assets/images/dr2.jpg", "Dr. Rodger Struck",
                  "Heart Surgeon, London, England"),
            ),
            Padding(
              padding: const EdgeInsets.all(17),
              child: cont2("assets/images/dr3.jpg", "Dr. Kathy Pacheco",
                  "Heart Surgeon, New Zealand"),
            ),
            Padding(
              padding: const EdgeInsets.all(17),
              child: cont2("assets/images/dr4.jpg", "Dr. Lorri Warf",
                  "Heart Surgeon, Africa"),
            ),
            Padding(
              padding: const EdgeInsets.all(17),
              child: cont2("assets/images/dr5.jpg", "Dr. Chris Glasser",
                  "Heart Surgeon, London, Dubai"),
            ),
            Padding(
              padding: const EdgeInsets.all(17),
              child: cont2("assets/images/dr6.jpg", "Dr. Stevi Jessi",
                  "Heart Surgeon, India"),
            ),
          ],
        ),
